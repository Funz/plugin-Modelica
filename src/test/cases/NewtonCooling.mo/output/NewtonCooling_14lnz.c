...
const char *NewtonCooling_linear_model_frame()
{
  ...
  "  output Real y[0];\n"
  "\n  Real 'x_T' = x[1];\n\n"
  "equation\n  der(x) = A * x + B * u;\n  y = C * x + D * u;\nend linear_NewtonCooling;\n";
}
const char *NewtonCooling_linear_model_datarecovery_frame()
{
